...
| iOS | `tuist generate`; `xcodebuild ... test` | Debug build, 저장 v1·v2→v9 이관, 시즌·결제·편성 상태 보존, 8/16시간 오프라인 상한, 유료 작업대·제작 속도·일일권, StoreKit 원장, iPhone Safe Area, iPad 정보 레일, 다중 적, 운영 메뉴, SKView 단일 루트 통과 | 로컬 iOS Simulator XCTest, 실제 캡처 |
