...
enum GameTextKey: String, CaseIterable, Sendable {
    ...
    case accessibilityActionSalvage = "accessibility.action.salvage"
    case accessibilityActionSettings = "accessibility.action.settings"
    ...
    case settingsConsoleSubtitle = "settings.console_subtitle"
    case settingsSavedImmediately = "settings.saved_immediately"
    case settingsAudioSection = "settings.audio_section"
    case settingsAccessSection = "settings.access_section"
